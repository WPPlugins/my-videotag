...
array('/youtube\.com\/playlist\?list=([^&]*)/i', '<div class="myvideotag" style="width:'.$w.'px;"><iframe width="'.$w.'" height="'.$h.'" src="http://www.youtube.com/embed/videoseries?list={ID_VIDEO}" frameborder="0" allowfullscreen></iframe></div>'),
...
//collegehumor.com/embed/*/tittleofvideo
array ('/collegehumor\.com\/embed\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.collegehumor.com/e/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></div>'),
...
array ('/collegehumor\.com\/video\/(.*)\/*/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.collegehumor.com/e/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></div>'),
...
//facebook.com
array ('/facebook\.com.*v=([^&]*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="https://www.facebook.com/video/embed?video_id={ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0"></iframe></div>'),

//funnyordie.com
array ('/funnyordie\.com\/videos\/(.*)\//i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.funnyordie.com/embed/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0"></iframe></div>'),
...
//dorkly.com
array ('/dorkly\.com\/video\/(.*)\//i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.dorkly.com/e/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></div>'),
array ('/dorkly\.com\/embed\/(.*)\//i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.dorkly.com/e/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></div>'),
...
array ('/wat\.tv\/embedframe\/(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.wat.tv/embedframe/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" scrolling="no" frameborder="0"></iframe></div>'),
array ('/wat\.tv\/(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.wat.tv/embedframe/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" scrolling="no" frameborder="0"></iframe></div>'),
...
//vxv.com
array ('/vxv\.com\/video\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.vxv.com/embed/{ID_VIDEO}/source/1" width="'.$w.'" height="'.$h.'" frameborder="0" overflow="hidden" allowfullscreen="true" scrolling="no" allowtransparency="yes"></iframe></div>'),
...
array ('/userporn\.com\/watch_video.php\?v=(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><object id="player" width="'.$w.'" height="'.$h.'" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ><param name="movie" value="http://www.userporn.com/e/{ID_VIDEO}" ></param><param name="allowFullScreen" value="true" ></param><param name="allowscriptaccess" value="always"></param><param name="wmode" value="transparent"></param><embed src="http://www.userporn.com/e/{ID_VIDEO}" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="'.$w.'" height="'.$h.'"></embed></object></div>'),
...
//zappinternet.com
array ('/zappinternet\.com\/video\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://zappinternet.com/embed/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0" scrolling="no" id="zappinternet_iframe">Necesitas un navegador que soporte iframes para poder ver este contenido.</iframe></div>'),
//zappin.me
array ('/zappin\.me\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://zappinternet.com/embed/{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0" scrolling="no" id="zappinternet_iframe">Necesitas un navegador que soporte iframes para poder ver este contenido.</iframe></div>'),
...
//dalealplay.com
array ('/dalealplay\.com.*=(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><object id="flashObj" width="640" height="360" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,47,0"><param name="movie" value="http://c.brightcove.com/services/viewer/federated_f9?isVid=1&isUI=1" /><param name="bgcolor" value="#FFFFFF" /><param name="flashVars" value="web=externos&videoId=ref:DAP-{ID_VIDEO}&playerID=71239000001&playerKey=AQ%2E%2E,AAAACC6Otfk%2E,O0scTulePyaCaQwsJ7JnGZq015vZEwl6&domain=embed&dynamicStreaming=true" /><param name="base" value="http://admin.brightcove.com" /><param name="wmode" value="transparent" /><param name="seamlesstabbing" value="false" /><param name="allowFullScreen" value="true" /><param name="swLiveConnect" value="true" /><param name="videoSmoothing" value="true" /><param name="allowScriptAccess" value="always" /><embed src="http://c.brightcove.com/services/viewer/federated_f9?isVid=1&isUI=1" wmode="transparent" bgcolor="#FFFFFF" flashVars="web=externos&videoId=ref:DAP-{ID_VIDEO}&playerID=71239000001&playerKey=AQ%2E%2E,AAAACC6Otfk%2E,O0scTulePyaCaQwsJ7JnGZq015vZEwl6&videoSmoothing=true&domain=embed&dynamicStreaming=true" base="http://admin.brightcove.com" name="flashObj" width="'.$w.'" height="'.$h.'" seamlesstabbing="false" type="application/x-shockwave-flash" allowFullScreen="true" allowScriptAccess="always" swLiveConnect="true" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"></embed></object></div>'),
...
//rutube.ru
array ('/rutube\.ru\/video\/embed\/(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe width="'.$w.'" height="'.$h.'" src="http://rutube.ru/video/embed/{ID_VIDEO}" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowfullscreen scrolling="no"></iframe></div>'),
...
//zkouknito.cz
array ('/zkouknito\.cz\/video_(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://www.zkouknito.cz/videoembed_{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0" scrolling="no"></iframe></div>'),
...
//videos.sapo.pt
array ('/videos\.sapo\.pt\/(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;"><iframe src="http://videos.sapo.pt/playhtml?file=http://rd3.videos.sapo.pt/{ID_VIDEO}/mov/1&relatedVideos=none&quality=sd" frameborder="0" scrolling="no" width="'.$w.'" height="'.$h.'"></iframe></div>'),
...
<object width="'.$w.'" height="'.$h.'"><param name="movie" value="http://videoplayer.vevo.com/embed/Embedded?videoId={ID_VIDEO}&playlist=false&autoplay=0&playerId=62FF0A5C-0D9E-4AC1-AF04-1D9E97EE3961&playerType=embedded&env=0&cultureName=en-US&cultureIsRTL=False"></param><param name="wmode" value="transparent"></param><param name="bgcolor" value="#000000"></param><param name="allowFullScreen" value="true"></param><param name="allowScriptAccess" value="always"></param><embed src="http://videoplayer.vevo.com/embed/Embedded?videoId={ID_VIDEO}&playlist=false&autoplay=0&playerId=62FF0A5C-0D9E-4AC1-AF04-1D9E97EE3961&playerType=embedded&env=0&cultureName=en-US&cultureIsRTL=False" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="'.$w.'" height="'.$h.'" bgcolor="#000000" wmode="transparent"></embed></object></div>'),

//movreel.com
array ('/movreel\.com\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><iframe src="http://movreel.com/embed/{ID_VIDEO}" width=607 height=470 border=0 frameborder=0 scrolling=no></iframe></div>'),

//shiatv.net
array ('/shiatv\.net\/view_video\.php\?viewkey=([^&]*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><embed src="http://www.shiatv.net/player41.swf?file=http://www.shiatv.net/runmyfile.php?vkey={ID_VIDEO}&autostart=false&showfsbutton=true&wmode=transparent&logo=http://www.shiatv.net/domainshiatv/images/logoplayer.png&link=http://www.shiatv.net" loop="False" width="500" height="370" allowfullscreen="true" allowscriptaccess="always" flashvars="width=500&height=370&file=http://www.shiatv.net/runmyfile.php?vkey={ID_VIDEO}&backcolor=0x000033&frontcolor=0xffffff&lightcolor=0xffffff&screencolor=0x000033&displayheight=370&displaywidth=500&searchbar=false&autoscroll=true&autostart=false&logo=http://www.shiatv.net/domainshiatv/images/logoplayer.png&link=http://www.shiatv.net name="/YouTube_video/youtube" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"\" /></div>'),

//gametrailers.com
array ('/gametrailers\.com\/videos\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><iframe src="http://media.mtvnservices.com/embed/mgid:moses:video:gametrailers.com:{ID_VIDEO}" width="'.$w.'" height="'.$h.'" frameborder="0"></iframe></div>'),

//videobam.com
array ('/videobam\.com\/(.*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><iframe title="VideoBam video player" type="text/html" frameborder="0" scrolling="no" width="'.$w.'" height="'.$h.'" src="http://videobam.com/widget/{ID_VIDEO}" allowFullScreen></iframe></div>'),

//youporn.com
array ('/youporn\.com\/watch\/([^?]*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><iframe src="http://www.youporn.com/embed/{ID_VIDEO}" frameborder="0" scrolling="no" width="'.$w.'" height="'.$h.'" name="yp_embed_video"></iframe></div>')
